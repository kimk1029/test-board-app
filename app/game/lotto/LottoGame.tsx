...
class SpaceRaceScene extends Phaser.Scene {
  ...
  private showSetupPanel() {
    ...
    const hintText = this.add.text(0, -170, '콤마로 구분하여 입력 (예: 짱구, 봉미선, 철수)', { fontSize: '14px', color: '#aaa' }).setOrigin(0.5)

    const inputHtml = `
      <textarea id="racer-names-input" placeholder="짱구, 봉미선, 철수, 유리, 훈이" 
